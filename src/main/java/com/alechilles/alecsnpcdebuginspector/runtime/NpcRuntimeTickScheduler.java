...
public final class NpcRuntimeTickScheduler {
    ...
    public RunSummary run(@Nonnull NpcRuntimeScenarioRun run,
        ...
        return new RunSummary(ticksRun, run.canceled(), cancelReason);
    }
    ...
    public record TickOutcome(boolean canceled, @Nullable String cancelReason) {
        @Nonnull
        ...
        public static TickOutcome canceled(@Nonnull String reason) {
            return new TickOutcome(true, reason);
        }
    }

    public record RunSummary(int ticksRun, boolean canceled, @Nullable String cancelReason) {
    }
}
